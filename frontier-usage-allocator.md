...
When the live session is on Codex fallback, do not pretend fallback work is spending Fable. Produce receipts and queue the synthesis-heavy work for the Shadow/Fable lane.
