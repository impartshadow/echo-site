...
Shadow has logged 1487 claim-boundary violations across 52 contract names. The useful thing is not the count. The useful thing is the mapping: unsupported claim -> missing receipt -> deterministic control.
...
- Fires logged: 245
- Latest seen: 2026-07-13T06:37:37-05:00 CT
...
- Redacted example: Completion/commit language while the repo still has uncommitted work: core/contract_generator.py, docs/agent-failure-flagship.html, docs/agent-failure-flagship.json, docs/agent-failure-flagship.md, docs/autopsy.html, docs/autopsy.xml, docs/failure-museum.html, docs/failure-museum.json, ... +1 more. Commit and push, or state that work remains uncommitted.

### The Agent Answered From Memory When The Question Required A Live Read

- Contract: `state-assertion-grounding`
- Fires logged: 99
- Latest seen: 2026-07-13T20:32:46-05:00 CT
...
- Fires logged: 76
- Latest seen: 2026-07-13T21:47:58-05:00 CT
